...
class CalendarModal extends Component {
    ...
    if (args.type === "Editor") {
      ...
      if (args.data && args.data.Id) {
        ...
        if (formElement && formElement.ej2_instances) {
          ...
          validator.addRules("patientName", {
            required: [true, "Required patient name"],
          });
          validator.addRules("phoneNumber", {
  ...
  OnEventRendered(args) {
    ...
    if (args.data.status === "Requested") {
      args.element.innerHTML =
        "Appointment " + "<br>" + "Pending " + "<br>" + "Confirmation";
    } else {
  ...
  editorTemplate(props) {
    return props !== undefined ? (
      ...
      >
        <tbody>
          <tr>
            <td className="e-textlabel">Date/Time</td>
            <td colSpan={4}>
          ...
          <tr>
            <td className="e-textlabel">Patient Name *</td>
            <td colSpan={4}>
              <input
                id="patientName"
                className="e-field e-isnput"
                type="text"
                name="patientName"
                style={{ width: "100%" }}
              />
  ...
  requestAppointment = (args) => {
    ...
    console.log(
      "selected doctors ID is :" + this.state.selectedDoctor.doctor.id
    );
    const appointment = {
      newPatient: true,
          ...
          <Row>
              ...
              <div className="row row-sm">
                <div className="col-4 profile-widget">
                  <div className="doc-img">
                    <a href="doctor-profile.html">
                      <img className="img-fluid" alt="User" src={doc_img2} />
                    </a>
                ...
                <div className="col-4 profile-widget">
                  <div className="pro-content">
                    <h3 className="title">
                      <a href="doctor-profile.html">
                        {this.props.location.state.doctor.doctor.name}
                      </a>
                      <i className="fas "></i>
                    </h3>
                    <p className="speciality">
                      {this.props.location.state.doctor.doctor.languages}
                    </p>
            ...
            <Col md={6}>
              <ScheduleComponent
                ...
                eventSettings={{
                  dataSource: this.scheduleDataMap[
